...
result. This allows us to generate  WDLMPro automatically as opposed to having to manually postedit alarge dataset.
...
For both tasks, we calculate the probability for the
string representation of the synset (i.e., $t \rightarrow
\bm{t}$). We obtain the string representation by removing
...
up''.  We then rank the candidates in ${\cal G}(t)$ based
