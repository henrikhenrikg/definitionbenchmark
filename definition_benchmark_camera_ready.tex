...
on this motivation, we introduce the \textit{Word
  Definitions Language Model Probing} (WDLMPro) dataset\footnote{WDLAMPro and evaluation scripts are available at \href{https://github.com/lksenel/definition_benchmark}{https://github.com/lksenel/definition\_benchmark}}; it
...
\textcolor{blue}{ Using taxonomic sisters,
  ...
  more challenging for statistical models that
...
language models \textcolor{blue}{perform clearly
...
\begin{table}
    ...
    \begin{tabular}{l|rrrr}
     ...
     GPT-2$_{s}$ & 0.69 & 35.0 & 45.0 & 0.71 \\
     GPT-2$_{m}$ & 0.80 & 50.0 & 50.0 & 0.73 \\
     GPT-2$_{l}$ & 0.84 & 60.0 & 45.0 & 0.75 \\
     GPT-2$_{xl}$ & 0.76 & 50.0 & 45.0 & 0.79 \\ \hline 
     Human & 0 & 0 & 0 & 0 \\ \hline 
